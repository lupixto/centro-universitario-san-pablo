...
const revealTargets = document.querySelectorAll(
  ".section-heading, .tuition-summary article, .program-card, .reason-card, .purpose-band, .campaign-card, .admission-step, .responsible-info article, .gallery-item, .testimonials-pending, .campus-card, .schedule-inline, .faq-list details, .contact-form"
);
